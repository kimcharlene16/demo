        ...
        <div class="container">
            <div class="row min-vh-100 align-items-center">
                <div class="content text-center text-md-left">
                    ...
                    <p>Make a schedule for the school</p>
                    <a href="schedule" class="link-btn">make schedule</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="sec">
            <div class="container">
                <div class="auto">
                    ...
                    <p>The school calendar as a part of a planning phase of the institution for the academic school year.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="about" id="about">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 content">
                    <span>Reminder</span>
                    <h3>Receive an reminder in email</h3>
                    <p>The calendar includes registration dates, class start dates, exam dates and more. It also includes all the schedules of the school events like foundation day and intramurals as well.</p>
                </div>
            </div>
        </div>
