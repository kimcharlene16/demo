...
if(isset($_POST['update_profile'])){
   ...
   if(!empty($course)) {
      mysqli_query($conn, "UPDATE `login` SET course = '$course' WHERE id = '$user_id'") or die('query failed');
      $message[] = 'updated successfully!';
   }else {
      $message[] = 'choose your course again';  
   }
...
<head>
   ...
   <link rel="stylesheet" href="account/css/acct.css">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <select name="course" value="<?php echo $fetch['course']; ?>" class="box">
